        ...
        <div className="py-gutter flex flex-col gap-md">
          ...
          <Card as="section" size="lg" className="relative overflow-hidden">
            <div className="relative z-10 max-w-[38ch]">
              <h1 className="mb-4 text-on-surface text-[clamp(2.5rem,8vw,4.5rem)] leading-[1.05] tracking-[-0.03em] font-bold !font-zyzol">
                P.R.I.T.
              </h1>
              ...
              <div className="flex flex-wrap items-center gap-sm">
                <Link
                  href="/members"
                  className="inline-flex items-center gap-2 px-6 py-3 rounded-full text-label-md transition-all bg-primary-container text-on-primary-container font-semibold"
                >
                  <MdPerson size={18} />
                ...
                {process.env.INSTAGRAM_URL && (
                  <Link
                    ...
                    className="w-11 h-11 rounded-full flex items-center justify-center transition-all bg-surface-container text-on-surface-variant"
